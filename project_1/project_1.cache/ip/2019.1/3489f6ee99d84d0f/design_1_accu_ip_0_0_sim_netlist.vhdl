...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_accu_ip_v1_0_S00_AXI is
  ...
  signal \table[1]_6\ : STD_LOGIC;
  signal \table[2]_2\ : STD_LOGIC;
  signal \table[3]_4\ : STD_LOGIC;
  signal \table[4]_0\ : STD_LOGIC;
  signal \table[5]_5\ : STD_LOGIC;
  signal \table[6]_1\ : STD_LOGIC;
  signal \table[7]_3\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \plusOp_carry__0_i_10\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \table[1][7]_i_2\ : label is "soft_lutpair2";
begin
...
\plusOp_carry__0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"ABFB5404"
        ...
        port map (
      I0 => position(3),
      I1 => \plusOp_carry__0_i_5_n_0\,
      I2 => position(2),
      I3 => \plusOp_carry__0_i_6_n_0\,
      I4 => somme(7),
      O => \plusOp_carry__0_i_1_n_0\
    );
\plusOp_carry__0_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFC0A0C0"
    )
        port map (
...
present1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => '0',
      DI(0) => present1_carry_i_3_n_0,
      O(3 downto 0) => NLW_present1_carry_O_UNCONNECTED(3 downto 0),
      S(3) => present1_carry_i_4_n_0,
      S(2) => present1_carry_i_5_n_0,
      S(1) => present1_carry_i_6_n_0,
      S(0) => present1_carry_i_7_n_0
    );
